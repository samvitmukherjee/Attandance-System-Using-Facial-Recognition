...
def accepted():
    ...
    background_image = ImageTk.PhotoImage(file=r'Background_Image_C.png',master=window)
    ...
    img = ImageTk.PhotoImage(PIL.Image.open('DTU_Logo.png'),master=window)

    # The Label widget is a standard Tkinter widget used to display a text or image on the screen.
    panel = tk.Label(window, image=img, width=170)
    ...
    trackImg = tk.Button(window, text="Track Images", command=TrackImages, fg="red", bg="green", width=20, height=1,
                         activebackground="Red", font=('Calbiri', 15, ' bold '))
