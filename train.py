...
message = tk.Label(window, text="Attandance System Using Facial Recognition]" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline'))
